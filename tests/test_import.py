...
def test_cellpose_imports_without_error():
    import multipose2
    from multipose2 import models, core
...
def test_gui_imports_without_error():
    from multipose2 import gui


def test_gpu_check():
    from multipose2 import core
    core.use_gpu()
...
def test_load_cp3_fail():
    from multipose2.models import CellposeModel, MODEL_DIR
    from multipose2 import utils
